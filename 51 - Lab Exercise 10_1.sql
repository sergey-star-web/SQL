...
group by o.orderdate,o.orderid,o.empid,o.custid
---------------------------------------------------------------------
-- Task 3
-- 
...
select (select sum(od.qty*od.unitprice) 
...
group by o.orderid)
from Sales.Orders as o1 inner join Sales.OrderDetails as od1
on o1.orderid=od1.orderid 
where month(o1.orderdate)=5 and year(o1.orderdate)=2008
group by o1.orderid
