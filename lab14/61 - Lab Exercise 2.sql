...
-- Task 1
-- 
-- Open the project file F:\10774A_Labs\10774A_14_PRJ\10774A_14_PRJ.ssmssln and the T-SQL script 61 - Lab Exercise 2.sql. Ensure that you are connected to the TSQL2012 database.
--
...
--  The column country.
--  Two new columns—custgroup and numberofcustomers. The custgroup column should hold the names of the source columns A, B, 
--  and C as character strings, and the numberofcustomers column should hold their values (i.e., number of customers).
--
...
---------------------------------------------------------------------
select custgroup, country, numberofcustomers from( select * from Sales.PivotCustGroups as pcg) as t1
unpivot (numberofcustomers for custgroup in (t1.A, t1.B, t1.C)) as unpvt
---------------------------------------------------------------------
-- Task 3
-- 
